...
export const ContactSection = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://formspree.io/f/mwpqlegg', {
        method: 'POST',
        headers: {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12">
          ...
          <div className="space-y-6 sm:space-y-8 p-6 sm:p-8 rounded-xl sm:rounded-2xl bg-gradient-to-br from-secondary/20 to-background border border-border">
            ...
            <div className="space-y-4 sm:space-y-6">
              <div className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 hover:bg-accent/30 rounded-lg sm:rounded-xl transition-all duration-300">
                ...
                <div className="text-start">
                  ...
                  <a
                    href="mailto:piyushraval2474@gmail.com"
            ...
            <div className="pt-6 sm:pt-8">
              <h4 className="font-medium mb-3 sm:mb-4 text-xs sm:text-sm text-muted-foreground text-start">Find me on</h4>
              <div className="flex gap-2 sm:gap-3">
                {[
                  {
                    icon: Linkedin,
                    label: "LinkedIn",
                    url: "https://www.linkedin.com/in/piyush-raval-939594261/",
                  },
                  {
                    icon: Twitter,
                    label: "Twitter",
                  ...
                  },
                  {
                    icon: Github,
                    label: "GitHub",
                    url: "https://github.com/PiyushRaval247",
                  },
                ].map((social, index) => (
                  <a
                    key={index}
