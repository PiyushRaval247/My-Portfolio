...
export const HeroSection = () => {
  ...
  return (
    <section
      id="hero"
      className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden bg-gradient-to-b from-background via-background/80 to-primary/5"
      ref={ref}
    >
      ...
      <motion.div 
        ...
        animate="float"
      >
        {['React', 'Node.js', 'JavaScript', 'Gsap', 'MongoDB'].map((tech, i) => (
          <motion.div 
            key={tech}
      ...
      <motion.div 
        ...
        animate="float"
      >
        {['Express', 'Next.js', 'MySQL', 'Tailwind', 'Redux'].map((tech, i) => (
          <motion.div 
            key={tech}
            className="px-4 py-2 bg-background/80 backdrop-blur-sm border rounded-full text-sm shadow-sm"
            initial={{ x: 20, opacity: 0 }}
